...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 01 fév. 2023 à 17:28
...
INSERT INTO `ligne_ticket` (`id_ligne_ticket`, `id_ticket`, `id_plat`, `quantite`, `commentaire`) VALUES
(34, 8, 5, NULL, NULL),
(35, 8, 5, NULL, NULL),
(36, 8, 5, NULL, NULL),
(37, 8, 5, NULL, NULL),
...
(49, 8, 8, NULL, NULL),
(62, 9, 34, NULL, NULL),
(70, 11, 5, NULL, 'sans eau'),
(71, 11, 25, NULL, NULL),
(72, 11, 11, NULL, NULL),
(73, 11, 5, NULL, 'sans rien'),
(74, 11, 5, NULL, 'sans oeuf'),
(126, 16, 5, NULL, NULL),
(127, 16, 5, NULL, NULL),
(128, 16, 5, NULL, NULL);
...
(23, 'AOC corbieres 2018 verre', 'cahteau etang des colombes', 'boisson', 3.50, 12, 0),
...
(29, 'AOC cotes du rhone rouge 75cl', 'il fait soif 2020', 'boisson', 20.50, 11, 0),
...
INSERT INTO `sous_categorie` (`id_sous_cat`, `id_cat`, `nom_sous_cat`, `ordre_aff_sous_cat`) VALUES
...
--
ALTER TABLE `ligne_ticket`
  MODIFY `id_ligne_ticket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
...
--
ALTER TABLE `plat`
  MODIFY `id_plat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT pour la table `sgr_table`
--
ALTER TABLE `sgr_table`
  MODIFY `id_table` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT pour la table `sous_categorie`
--
ALTER TABLE `sous_categorie`
  MODIFY `id_sous_cat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
