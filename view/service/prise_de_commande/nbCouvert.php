...
if ($_SESSION["role"] == "service") {
    ...
    <body>
        <div class="l-form">
            <form method="POST" class="form" id="FormulaireNbCouvert">
                ...
                <div class="form__div">
                    <input type="number" class="form__input" name="nb_couvert" id="nb_couvert" autocomplete="off"
                        placeholder=" ">
                    <label for="nb_couvert" class="form__label">Entrez un nombre de couvert</label>
                </div>

                <input type="submit" class="form__button" value="Valider" name="nbC"> <br>
